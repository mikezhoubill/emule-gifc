...
; *** SetupLdr messages
SetupLdrStartupMessage=Este programa vai instalar o %1. Você quer continuar?
...
WelcomeLabel2=Esse Assistente vai instalar o [name/ver] no seu computador.%n%nRecomenda-se fechar todos os outros programas antes de continuar.
...
SelectDirLabel3=O Programa de Instalação vai instalar o [name] na seguinte pasta.
...
SelectTasksLabel2=Selecione as tarefas adicionais que você deseja que o Programa de Instalação execute enquanto instala o [name] e clique em Avançar.		
...
ReadyLabel1=O Programa de Instalação está pronto para começar a instalação do [name] no seu computador.
