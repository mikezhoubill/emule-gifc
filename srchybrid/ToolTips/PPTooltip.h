...
//	CMap <HWND, HWND, m_arrToolsWnd, m_arrToolsWnd&> m_mapTools;
	...
	CSize m_szImage;
	UINT  m_maxtooltipid; //leuk_he added for treecrontrol
...
public:
	...
	int AddTool(CTreeCtrl * pWnd, UINT nIdText); // leuk_he for tree control
	void AddTool(PPTOOLTIP_INFO ti); //Adds tool
	int  FindTool(CPoint & pt);
	int  FindTool(CWnd * pWnd, LPCRECT lpRect = NULL,UINT  ptoolid=999999);
