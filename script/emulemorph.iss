...
[Setup]
AppName=eMule
AppVerName=stullemuleemuleversion
AppPublisher=Stulle
...
Filename: "netsh"; PArameters:"firewall add allowedprogram ""{app}\emule.exe"" eMuleStulleMule enable all" ; flags: runminimized; Tasks: firewall
